...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Tambah Sambutan</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.greetings.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="section_name" 
                                   name="section_name" 
                                   value="{{ old('section_name', 'Sambutan') }}" 
                                   required>
