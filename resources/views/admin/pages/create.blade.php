...
<div class="row">
    <div class="col-lg-8">
        <div class="content-card mb-3">
            <div class="content-card-header">
                <h5><i class="fas fa-file-alt me-2"></i>Informasi Halaman</h5>
            </div>

            <div class="mb-3">
                <label class="form-label">Title <span class="text-danger">*</span></label>
                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" 
                       required value="{{ old('title') }}" placeholder="Masukkan judul halaman">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" 
                       value="{{ old('slug') }}" placeholder="auto-generate dari title">
            ...
            <div class="mb-3">
                ...
                <textarea name="excerpt" class="form-control @error('excerpt') is-invalid @enderror" 
                          rows="3" placeholder="Ringkasan singkat halaman">{{ old('excerpt') }}</textarea>
                @error('excerpt')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="content-card">
            <h6 class="mb-3"><i class="fas fa-info-circle me-2"></i>Contoh Halaman</h6>
            <ul class="small list-unstyled">
                <li class="mb-2"><strong>Top Bar:</strong></li>
                <li>- Staf</li>
                <li>- Mahasiswa</li>
                <li>- Alumni</li>
                <li class="mb-2 mt-2"><strong>Main Menu:</strong></li>
                <li>- Profil</li>
                <li>- Visi & Misi</li>
                <li>- Sejarah</li>
                <li>- Penerimaan</li>
