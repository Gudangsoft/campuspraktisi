        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                              rows="4">{{ old('description', $agenda->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    @if($agenda->image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/'.$agenda->image) }}" class="img-fluid rounded" style="max-height: 200px;">
                        </div>
                    @endif
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" name="is_active" class="form-check-input" id="is_active" 
                           value="1" {{ old('is_active', $agenda->is_active) ? 'checked' : '' }}>
