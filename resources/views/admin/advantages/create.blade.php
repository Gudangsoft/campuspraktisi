...
<div class="content-card">
    <div class="content-card-header">
        <h5><i class="fas fa-plus-circle me-2"></i>Tambah Keunggulan Baru</h5>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          placeholder="Jelaskan keunggulan ini...">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                       name="icon" value="{{ old('icon', 'fa-star') }}" 
            ...
            <div class="col-md-6">
                ...
                <input type="color" class="form-control form-control-color @error('icon_color') is-invalid @enderror" 
                       name="icon_color" value="{{ old('icon_color', '#3498db') }}" required>
